...
// Demo data removed - application starts with clean database
// Users will create their own categories and expenses
...
async function ensureSeedData() {
  ...
  if (seeded) return;
  // Auto-seeding disabled - start with clean database
  // Users will create their own categories and expenses
  seeded = true;
}
